...
// general variables
$fn = $preview ? 32: 128; // high resolution for rendering, low resolution when designing
eps1 = 0.001; // "epsilon", small value to avoid collisions
eps2 = 2 * eps1;

// Choose syringe model
include <syringe-10cc-generic.scad>;
//include <syringe-10cc-flux.scad>;
...
// adapter for cnc3018
cnc_zcarriage_dia1 = 52.0; // diameter of spindle hole. Common values: 45mm, 52mm.
