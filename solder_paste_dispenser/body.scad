...
module body() {
    ...
    difference() {
        ...
        hull() {
            cube([stepper_length, syringe_flange_width+2*clearance_fit, eps2], center=true);
            translate([0,0,syringe_flange_thickness-tight_fit])
            cube([stepper_length, syringe_flange_width,eps2], center=true);
        }
